...
class Admin extends Component
{
    ...
    {
        $this->datas = CtcEvent::latest()->get();
    }
    ...
    public function deleteSelected()
    {
        ...
        CtcEvent::whereIn('id', $this->selectedRows)->delete();
        $this->selectedRows = [];
    ...
    {
        $event = CtcEvent::with('ctcDashboard')->find($eventId);
    ...
    public function updateEvent()
    {
        ...
        $event = CtcEvent::find($this->editingEventId);
    ...
    public function resetEventForm()
    {
        if ($this->isEditMode) {
            ...
            $selectedItem = null;
            if (!empty($this->selectedRows)) {
                $selectedItem = \App\Models\Ctcdashboard::find($this->selectedRows[0]);
            }
    ...
    {
        $query = CtcEvent::with('ctcDashboard');

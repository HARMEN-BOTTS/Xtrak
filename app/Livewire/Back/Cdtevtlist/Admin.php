...
class Admin extends Component
{
    ...
    {
        $this->datas = CdtEvent::latest()->get();
    }
    ...
    public function deleteSelected()
    {
        ...
        CdtEvent::whereIn('id', $this->selectedRows)->delete();
        $this->selectedRows = [];
    ...
    {
        $event = CdtEvent::with('cdtDashboard')->find($eventId);
    ...
    public function updateEvent()
    {
        ...
        $event = CdtEvent::find($this->editingEventId);
    ...
    public function resetEventForm()
    {
        if ($this->isEditMode) {
            ...
            $selectedItem = null;
            if (!empty($this->selectedRows)) {
                $selectedItem = \App\Models\Candidate::find($this->selectedRows[0]);
            }
    ...
    {
        $query = CdtEvent::with('cdtDashboard');

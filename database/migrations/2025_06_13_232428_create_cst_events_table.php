...
return new class extends Migration
{
     ...
     * Run the migrations.
     */
    // database/migrations/xxxx_create_cst_events_table.php
    public function up()
    {
        Schema::create('cst_events', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('cst_id')->references('id')->on('cstdashboards')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('cst_events');
    }
};

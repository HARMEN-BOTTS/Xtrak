                ...
                <div class="p-1 flex-grow-1">
                    ...
                    <div class="button-group-main">
                        <div class="button-group-left-main">
                            ...
                            <div class="mt-1">
                                <input style="width:90px; padding:5px;" type="text" placeholder="{{ $item->trgDashboard->trg_code ?? '--' }}"></input>
                            </div>
                            <div class="mt-1">
                                <input style="width:120px;padding:5px;" type="text" placeholder="{{ $item->trgDashboard->company ?? '--' }}"></input>
                            </div>
                            @endforeach
                            @else
                            <div class="mt-2">
                                <h5>ALL OPEN STATUS TRGS EVENTS</h5>
                            </div>
                            @endif
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr wire:key="row-{{ $item->id }}"
                                    ...
                                    <td>{{ $item->type }}</td>
                                    <td>{{ $item->io }}</td>
                                    <td>{{ $item->trgDashboard->first_name ?? '' }}</td>
                                    <td>{{ $item->trgDashboard->last_name ?? '' }}</td>
                                    <td>{{ $item->object }}</td>
                                    <td>{{ $item->status }}</td>
                                    <td>{{ $item->comment }}</td>
                                    <td>{{ $item->next }}</td>
                                ...
                                @else
                                <tr>
                                    <td colspan="11" class="text-center">No events available</td>
                                </tr>
                                @endif
                            </tbody>
        ...
        <div id="evtModal" class="modal" style="display: block;">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 style="background:#FFB4A2;width:18%;padding:7px;text-align:center">
                        TRG_EVTform
                    </h2>
                </div>
                ...
                <div class="status-buttons">
                    <button class="status-btn" wire:click="$set('eventFormData.status', 'OCC')">OCC</button>
                    <button class="status-btn" wire:click="$set('eventFormData.status', 'NRP')">NRP</button>
                    <button class="status-btn" wire:click="$set('eventFormData.status', 'NRJ')">NRJ</button>
                    <button class="status-btn" wire:click="$set('eventFormData.status', 'WRN')">WRN</button>
                    <button class="status-btn" wire:click="$set('eventFormData.status', 'NHS')">NHS</button>
                </div>
                ...
                <div id="evtForm">
                    <div class="form-row">
                        <div class="form-group statut-field">
                            ...
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.trg_code">
                        </div>
                        <div class="form-group objet-field">
                            <label>Company</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.company">
                        </div>
                        <div class="form-group statut-field">
                            <label>CTC_Code</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.ctc_code">
                        </div>
                        <div class="form-group retour-field">
                            <label>First Name</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.first_name">
                        </div>
                        <div class="form-group retour-field">
                            <label>Last Name</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.last_name">
                        </div>
                        <div class="form-group statut-field">
                            <label>Function</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.position">
                        </div>
                    </div>

                    <!-- Second Row - Event Details (Editable) -->
                    <div class="form-row">
                        <div class="form-group date-field">
                            <label>Date</label>
                            <input type="date" class="form-control1"
                                wire:model="eventFormData.event_date">
                        </div>
                        <div class="form-group type-field">
                            <label>Type</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.type">
                        </div>
                        <div class="form-group io-field">
                            <label>I/O</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.io">
                        </div>
                        <div class="form-group objet-field">
                            <label>Objet</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.object">
                        </div>
                        <div class="form-group statut-field">
                            <label>Statut</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.status">
                        </div>
                        <div class="form-group retour-field">
                            <label>Retour</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.retour">
                        </div>
                        <div class="form-group statut-field">
                            <label>Temper</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.temper">
                        </div>
                    </div>
                    ...
                    <div class="comment-section">
                        <div class="form-group comment-field">
                            <label>Comment</label>
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.comment">
                        </div>
                        <div class="right-section">
                            <div class="next-ech-row">
                                <div class="form-group next-field">
                                    <label>Next</label>
                                    <input type="text" class="form-control1"
                                        wire:model="eventFormData.next">
                                </div>
                                <div class="form-group ech-field">
                                    <label>Ech</label>
                                    <input type="text" class="form-control1"
                                        wire:model="eventFormData.ech">
                                </div>
                                <div class="form-group ech-field">
                                    <label>Priority</label>
                                    <input type="text" class="form-control1"
                                        wire:model="eventFormData.priority">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="comment-section">
                        <div class="form-group retour-field">
                            ...
                            <input type="text" class="form-control1"
                                wire:model="eventFormData.last_comment">
                        </div>
                        <div class="right-section">
                            <div class="next-ech-row">
                                <div class="form-group last-field">
                                    ...
                                    <input type="date" class="form-control1"
                                        wire:model="eventFormData.date_last_comment">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control1"
                                wire:model="eventFormData.other_comment"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Note1</label>
                            <textarea class="form-control1"
                                wire:model="eventFormData.note1"></textarea>
                        </div>
                    </div>

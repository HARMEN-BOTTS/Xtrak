    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        ...
        @else
         <div id="container">
            <button class="circle" style="font-size:1rem; background-color: #FFC0CB;" id="EVT1">EVT</button>
            <button class="circle" style="font-size:1rem; background-color: #FFA500;" id="EVT2">XTK</button>
            <button class="circle" style="font-size:1rem; background-color: #FF0000;" id="">MCP</button>
            <button class="circle" style="font-size:1rem; background-color: #800080;" id="">OPP</button>
            <button class="circle" style="font-size:1rem; background-color: #808080;" id="">TRG</button>
            <button class="circle" style="font-size:1rem; background-color: #FFFF00;" id="CDT">CDT</button>
            <button class="circle" style="font-size:1rem; background-color: #00FFFF;" id="">ANN</button>
            <button class="circle" style="font-size:1rem; background-color: #00FF00;" id="">CTC</button>
